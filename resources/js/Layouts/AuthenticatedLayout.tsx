            ...
            <main>
                ...
                {flash?.success && (
                    <div className="mx-auto max-w-7xl pt-6 sm:px-6 lg:px-8">
                        <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative dark:bg-green-900 dark:border-green-700 dark:text-green-300">
                            {flash.success}
                        </div>
                    </div>
                )}
